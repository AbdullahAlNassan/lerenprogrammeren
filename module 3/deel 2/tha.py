    ...
    if len(adventurerGear)  > 0:
        ...
        if cashInGold == None:
            ...
            if totalCost > cashInGold:
                ...
                print_colorvars('De totale kosten tot nu toe {} goud en dan moet het eten voor de rest van de groep en paarden nog gekocht worden.',[totalCost])
                print_colorvars('Gelukkig heeft de groep {} goud te besteden.',[cashInGold])
