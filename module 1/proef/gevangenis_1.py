...
def volg_de_tunnel():
    ...
    print("de tunnel is blijkbaar lang en heeft 3 richtingen")
...
def make_decision_1():
    ...
    if choice == "1":
        print("Bedankt voor het spelen. Tot volgende keer!")
        return "fail", False()
    elif choice == "2":
